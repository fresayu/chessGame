...
Cavalier::Cavalier::Cavalier(Cavalier* cavalier) : Cavalier(cavalier->positionActuelle, cavalier->couleur_, cavalier->nom_) {

}

std::shared_ptr<PieceTableau::Piece> Cavalier::Cavalier::getInstanceCavalierGauche(Couleur couleur) {
...
std::shared_ptr<PieceTableau::Piece> Cavalier::Cavalier::getInstanceCavalierDroite(Ajout::Couleur couleur) {
